...
class AroundAop
{
     ...
     * @PointCut(
     *     allow={
     *         "Imi\Test\Aop\Classes\TestAroundClass::test"
     *     }
     * )
     *
     * @return void
    ...
    public function injectAroundAop(AroundJoinPoint $joinPoint)
    {
        ...
        Assert::assertEquals(\Imi\Test\Aop\Classes\TestAroundClass::class, BeanFactory::getObjectClass($joinPoint->getTarget()));

...
class AfterReturningAop
{
     ...
     * @PointCut(
     *     allow={
     *         "Imi\Test\Aop\Classes\TestAfterReturningClass::test"
     *     }
     * )
     *
     * @return void
    ...
    public function injectAfterReturningAop(AfterReturningJoinPoint $joinPoint)
    {
        ...
        Assert::assertEquals(\Imi\Test\Aop\Classes\TestAfterReturningClass::class, BeanFactory::getObjectClass($joinPoint->getTarget()));

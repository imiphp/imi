...
$__DIR__/src/Cli/bin/imi-cli generate/model "Imi\Model\Test\Model" --app-namespace "Imi\Model\Test" --prefix=tb_ --override=base --lengthCheck --sqlSingleLine --exclude tb_prefix

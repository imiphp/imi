...
let div_str = `
   <div class="loader twink" style="width: 70px;height: 70px;text-align: center;"><img src="assets/images/logo-280.png" alt="imi 框架 Logo" class="logo" style="width:70px;"></div>
`;

...
{
    public function __construct(?array $__data = null, ?string $id = null, ?string $type = null, ?int $waitTimeout = null, ?int $lockExpire = null, array $options = [], ?callable $afterLock = null, bool $useConfig = true)
    {

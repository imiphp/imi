...
class PolymorphicToOne extends RelationBase
{
     ...
     */
    public function __construct(?array $__data = null, string $model = '', string $modelField = '', string $field = '', string $type = '', $typeValue = null, ?array $fields = null, bool $with = false, ?array $withFields = null, bool $withSoftDelete = false, $poolName = RelationPoolName::PARENT)
    {

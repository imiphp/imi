...
class PolymorphicOneToMany extends RelationBase
{
     ...
     */
    public function __construct(?array $__data = null, string $model = '', string $type = '', $typeValue = null, ?string $order = null, ?array $fields = null, ?int $limit = null, bool $with = false, ?array $withFields = null, bool $withSoftDelete = false, $poolName = RelationPoolName::PARENT)
    {

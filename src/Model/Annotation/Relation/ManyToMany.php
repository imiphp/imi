 ...
 * @property int|string|null $poolName       连接池名称，或 \Imi\Model\Enum\RelationPoolName 中的常量
 */
...
class ManyToMany extends RelationBase
{
     ...
     */
    public function __construct(?array $__data = null, string $model = '', string $middle = '', string $rightMany = '', ?string $order = null, ?array $fields = null, ?int $limit = null, bool $with = false, ?array $withFields = null, bool $withSoftDelete = false, $poolName = RelationPoolName::PARENT)
    {

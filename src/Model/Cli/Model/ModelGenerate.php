...
class ModelGenerate extends BaseCommand
{
    ...
    #[Argument(name: 'baseClass', type: 'string', default: 'Imi\\Model\\Model', comments: '生成的Model所继承的基类,默认\\Imi\\Model\\Model,可选')]
    #[Option(name: 'database', type: 'string', comments: '数据库名，不传则取连接池默认配置的库名')]
    #[Option(name: 'poolName', type: 'string', comments: '连接池名称，不传则取默认连接池')]
    #[Option(name: 'prefix', type: 'array_ex', default: [], comments: '传值则去除该表前缀，以半角逗号分隔多个前缀')]
    ...
    #[Option(name: 'sqlSingleLine', type: 'boolean', default: false, comments: '生成的SQL为单行,默认false,可选')]
    #[Option(name: 'lengthCheck', type: 'boolean', default: false, comments: '是否检查字符串字段长度,可选')]
    #[Option(name: 'ddlEncode', type: 'string', comments: 'DDL 编码函数', default: '')]
    #[Option(name: 'ddlDecode', type: 'string', comments: 'DDL 解码函数', default: '')]

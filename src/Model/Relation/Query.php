...
class Query
{
     ...
     */
    public static function initByPolymorphicOneToOne(Model $model, string $propertyName, array $annotation): void
    {
        $className = BeanFactory::getObjectClass($model);
        $eventName = 'IMI.MODEL.RELATION.QUERY.' . $className . '.' . $propertyName;
     ...
     */
    public static function initByPolymorphicOneToMany(Model $model, string $propertyName, array $annotation): void
    {
        $className = BeanFactory::getObjectClass($model);
        $eventName = 'IMI.MODEL.RELATION.QUERY.' . $className . '.' . $propertyName;
     ...
     */
    public static function initByPolymorphicManyToMany(Model $model, string $propertyName, array $annotation): void
    {
        $className = BeanFactory::getObjectClass($model);
        $eventName = 'IMI.MODEL.RELATION.QUERY.' . $className . '.' . $propertyName;

...
use Imi\Swoole\Server\UdpServer\Route\Annotation\UdpRoute as UdpRouteAnnotation;
...
class UdpRoute implements IRoute
{
     ...
     * 增加路由规则，直接使用注解方式.
     *
     * @param Imi\Swoole\Server\UdpServer\Route\AnnotationServer\UdpRoute $annotation
     ...
     * 路由规则是否存在.
     *
     * @param Imi\Swoole\Server\UdpServer\Route\AnnotationServer\UdpRoute $rule
     *
     * @return bool
     */
     ...
     * 获取路由规则.
     *
     * @return \Imi\Swoole\Server\UdpServer\Route\RouteItem[]
     */

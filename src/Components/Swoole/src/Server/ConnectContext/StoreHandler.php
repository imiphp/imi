...
namespace Imi\Swoole\Server\ConnectContext;

use Imi\Bean\Annotation\Bean;
use Imi\RequestContext;
use Imi\Swoole\Server\ConnectContext\StoreHandler\IHandler;
...
class StoreHandler implements IHandler
{
     ...
     * @var string
     */
    protected string $handlerClass = \Imi\Swoole\Server\ConnectContext\StoreHandler\Redis::class;
     ...
     * 获取处理器.
     *
     * @return \Imi\Swoole\Server\ConnectContext\StoreHandler\IHandler
     */

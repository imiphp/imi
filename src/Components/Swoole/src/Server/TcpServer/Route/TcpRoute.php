...
use Imi\Swoole\Server\TcpServer\Route\Annotation\TcpRoute as TcpRouteAnnotation;
...
class TcpRoute implements IRoute
{
     ...
     * 增加路由规则，直接使用注解方式.
     *
     * @param Imi\Swoole\Server\TcpServer\Route\AnnotationServer\TcpRoute $annotation
     ...
     * 路由规则是否存在.
     *
     * @param Imi\Swoole\Server\TcpServer\Route\AnnotationServer\TcpRoute $rule
     *
     * @return bool
     */
     ...
     * 获取路由规则.
     *
     * @return \Imi\Swoole\Server\TcpServer\Route\RouteItem[]
     */

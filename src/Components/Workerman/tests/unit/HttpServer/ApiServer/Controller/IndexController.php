...
namespace Imi\Workerman\Test\HttpServer\ApiServer\Controller;
...
class IndexController extends SingletonHttpController
{
     ...
     * @Action
     * @Route("/middleware")
     * @Middleware(\Imi\Workerman\Test\HttpServer\ApiServer\Middleware\Middleware1::class)
     * @Middleware({
     *  \Imi\Workerman\Test\HttpServer\ApiServer\Middleware\Middleware2::class,
     *  \Imi\Workerman\Test\HttpServer\ApiServer\Middleware\Middleware3::class
     * })
     * @Middleware("@test")
     *
     * @return void

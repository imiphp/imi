...
use Imi\Model\Test\Model\MemberRoleRelation;
use Imi\Model\Test\Model\MemberWithArticles;
use Imi\Model\Test\Model\MemberWithRelation;
use Imi\Model\Test\Model\MemberWithRoles;
use Imi\Model\Test\Model\Polymorphic;
...
class ModelRelationTest extends BaseTest
{
    ...
    public function testOneToOne(array $args): array
    {
        ...
        $list = Article::query()->with(['ex' => static function (\Imi\Model\Contract\IModelQuery $query, OneToOne $annotation) use (&$callableAnnotation): void {

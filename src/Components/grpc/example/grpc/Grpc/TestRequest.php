...
class TestRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *     @var int $int
     *     @var string $string
     *     @var \Grpc\LoginRequest $message
     *     @var \Grpc\LoginRequest[]|\Google\Protobuf\Internal\RepeatedField $messages
     *     @var \Google\Protobuf\Any $any
     *     @var array|\Google\Protobuf\Internal\MapField $map
     *     @var array|\Google\Protobuf\Internal\MapField $map2
     *     @var \Google\Protobuf\Any[]|\Google\Protobuf\Internal\RepeatedField $anys
     *     @var int $enum
     *     @var bool $bool
     *     @var \Google\Protobuf\Timestamp $timestamp
     *     @var \Google\Protobuf\Duration $duration
     *     @var \Google\Protobuf\Struct $struct
     *     @var \Google\Protobuf\FieldMask $fieldMask
     *     @var string[]|\Google\Protobuf\Internal\RepeatedField $strings
     * }
     */

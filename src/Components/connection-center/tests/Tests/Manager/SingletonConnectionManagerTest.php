...
class SingletonConnectionManagerTest extends TestCase
{
    ...
    {
        $connectionManager = App::newInstance(SingletonConnectionManager::class, SingletonConnectionManager::createConfig(['driver' => TestDriver::class, 'enableStatistics' => $enableStatistics, 'resources' => [['test' => true]]]));
     ...
     * @depends testCreateConnectionManager
     */
    public function testGetInstanceAfterRelease(SingletonConnectionManager $connectionManager): void
    {
        $connection = $this->testGetConnection($connectionManager);
        $this->assertEquals(ConnectionStatus::Available, $connection->getStatus());
        $connection->release();
     ...
     * @depends testCreateConnectionManager
     */
    public function testReleaseAfterRelease(SingletonConnectionManager $connectionManager): void
    {
        $connection = $this->testGetConnection($connectionManager);
        $this->assertEquals(ConnectionStatus::Available, $connection->getStatus());
        $connection->release();
     ...
     * @depends testCreateConnectionManager
     */
    public function testDetachAfterRelease(SingletonConnectionManager $connectionManager): void
    {
        $connection = $this->testGetConnection($connectionManager);
        $this->assertEquals(ConnectionStatus::Available, $connection->getStatus());
        $connection->release();

...
class RequestTest extends BaseTest
{
    ...
    {
        $http = new HttpRequest();
        $file = new UploadedFile(basename(__FILE__) . '.html', MediaType::TEXT_HTML, __FILE__);
        $http->content([
            'file'  => $file,
        ]);
        ...
        $this->assertEquals(basename(__FILE__) . '.html', $file['clientFilename']);
    ...
    public function testUploadMulti(): void
    {
        ...
        $file1 = new UploadedFile(basename(__FILE__) . '.html', MediaType::TEXT_HTML, __FILE__);

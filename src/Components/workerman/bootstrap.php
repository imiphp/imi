...
return static function (): void {
    ...
    // 事件监听
    Event::on('IMI.LOAD_RUNTIME_INFO', static fn (LoadRuntimeInfoEvent $e) => App::newInstance(\Imi\Workerman\Process\Listener\LoadRuntimeListener::class)->handle($e), 19940000);
    Event::on('IMI.BUILD_RUNTIME', static fn (BuildRuntimeInfoEvent $e) => App::newInstance(\Imi\Workerman\Process\Listener\BuildRuntimeListener::class)->handle($e), 19940000);

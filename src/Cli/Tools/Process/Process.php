...
class Process extends BaseCommand
{
     ...
     * 开启一个进程，可以任意添加参数.
     *
     * @CommandAction(name="start", co=false, dynamicOptions=true)
     *
     ...
     * 开启一个进程池，可以任意添加参数.
     *
     * @CommandAction(name="pool", co=false, dynamicOptions=true)
     *
     ...
     * 运行一个进程.
     *
     * @CommandAction(name="run", co=false, dynamicOptions=true)
     *
     * @Argument(name="name", type=ArgType::STRING, required=true, comments="进程名称，通过@Process注解定义")
     *
     * @return void

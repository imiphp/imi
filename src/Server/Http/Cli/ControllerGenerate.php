...
class ControllerGenerate extends BaseCommand
{
    ...
    #[Argument(name: 'name', type: 'string', required: true, comments: '生成的 Controller 类名')]
    #[Argument(name: 'namespace', type: 'string', required: true, comments: '生成的 Controller 所在命名空间')]
    #[Option(name: 'prefix', type: 'string', comments: '路由前缀，不传则为类名')]
    #[Option(name: 'render', type: 'string', default: 'json', comments: '渲染方式，默认为json，可选：html/json/xml')]
    #[Option(name: 'rest', type: 'boolean', default: false, comments: '是否生成 RESTful 风格，默认 false')]
    #[Option(name: 'override', type: 'boolean', default: false, comments: '是否覆盖已存在的文件，请慎重！(true/false)')]
